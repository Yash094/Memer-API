...
class Meme {
    ...
    abandon(text) {
        if (!text) throw new SyntaxError("A String is required for the TEXT");
    	if(typeof text !== "string") throw new SyntaxError(`Passed in ${typeof text} but a String would be required for the TEXT`);
    ...
    */
    ...
    failure(avatar) {
        if (!avatar) throw new SyntaxError("A String/File is required for the AVATAR");
        if (!Util.isImage(avatar)) throw new SyntaxError(`Passed in ${avatar} but an IMGAE would be required`);
    ...
    bed(avatar1, avatar2) {
        ...
        if (!Util.isImage(avatar1)) throw new SyntaxError(`Passed in ${avatar1} but an IMGAE would be required for the FIRST AVATAR`);
        if (!avatar2) throw new SyntaxError("A String is required for the SECOND AVATAR");
        if (!Util.isImage(avatar2)) throw new SyntaxError(`Passed in ${avatar2} but an IMGAE would be required for the SECOND AVATAR`);
    ...
    byemom(avatar, username, text) {
        ...
        if(typeof username !== "string") throw new SyntaxError(`Passed in ${typeof username} but a String would be required for the USERNAME`);
        if (!text) throw new SyntaxError("A String is required for the TEXT");
    	if(typeof text !== "string") throw new SyntaxError(`Passed in ${typeof text} but a String would be required for the TEXT`);
