...
class Meme {
    ...
    async youtube(avatar, username, text) {
        let data = await fetch.get(`${base}/youtube?avatars=${avatar}&usernames=${username}&text=${text}`, {
 ...
 /**
    ...
    async tweet(avatar, username, text) {
        let data = await fetch.get(`${base}/tweet?avatars=${avatar}&usernames=${username}&text=${text}`, {
